...
def splitnumandstr():
    ...
    # excelprocess.write_in_csv(writecsvname,datalist)
...
def extractnumwithstr(readcsvname,writecsvname):
    ...
    # excelprocess.createListCSV(writecsvname, finalmedicallist)
...
def seperateNone():
    ...
    # excelprocess.write_in_csv(writenormalcsvname , normalList)
    # excelprocess.write_in_csv(writenonecsvname, noneLise)
...
def unitTransformation():
    ...
    # excelprocess.write_in_csv(writecsvname , normalList)
